//#region node_modules/.nitro/vite/services/ssr/assets/scenarios-Do0PAKGu.js
...
var SCENARIOS = [
	{
		...
		instructorNote: "Отказ Н-1. Падает уровень в аппаратах. Сначала погасите печь, затем остановите Н-3 и Н-2.",
	...
	},
	{
		...
		instructorNote: "Переполнение Э-1 водой привело к короткому замыканию. Слейте воду через дренаж и восстановите 4.8 кВ.",
	...
	},
	{
		...
		instructorNote: "Отключена подача деэмульгатора. Вода пошла в колонну К-1. Восстановите реагент и будьте готовы сбросить давление на факел.",
	...
	},
	{
		...
		instructorNote: "Клапан PCV-221 заклинил, сброса нет. Экстренно гасите печь П-3: TRC-3 в ручной и газ 0%, иначе взрыв колонны.",
	...
	},
	{
		...
		instructorNote: "Клапан газа печи заклинил на 100%. Срочно увеличьте подачу сырья до 100% для съёма тепла и держите циркуляцию Н-3.",
	...
	},
	{
		...
		instructorNote: "Обрыв топливного газа. Печь погасла. Переведите TRC-3 в ручной и перекройте клапан — не дайте ПИД открыть газ при появлении давления.",
	...
	},
	{
		...
		instructorNote: "В нефть попала вода с ЭЛОУ. Резкое вскипание в печи. Откройте сброс PCV-221 на факел.",
	...
	},
	{
		...
		instructorNote: "Отказ кулера АВЗ-1. Температура верха К-1 растёт. Снизьте нагрузку на печь: TRC-3 в ручной и убавьте газ.",
...
var INSTRUCTOR_TRIGGERS = /* @__PURE__ */ new Set([
	"break_pump_h1",
	"jam_pcv",
	"jam_gas",
	"break_avz",
...
//#endregion
export { getScenario as i, SCENARIOS as n, describeAction as r, INSTRUCTOR_TRIGGERS as t };
