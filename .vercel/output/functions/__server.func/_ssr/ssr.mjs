...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CWsQz4Tz.mjs");
...
var manifest = {
	"d9b7f3703f538ded2869fe11aba11fd4ec12d6ef5cfab6bd9b736aa1a930f982": {
		functionName: "askTutor_createServerFn_handler",
		importer: () => import("./tutor-CNwtNycZ.mjs")
	},
	"edb92658caa6dd02e38c36433371162880e57724894ae7871d23a095bc4d925a": {
		functionName: "generateDebrief_createServerFn_handler",
		importer: () => import("./tutor-CNwtNycZ.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-DPgxt7S5.mjs").then((n) => n.t),
